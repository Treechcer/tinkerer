...
function entitiesIndex.f.init()
    ...
    entitiesIndex.f.addIndex("conveyor_belt", true, 4, bit.addBit({bit.BIT4}), 1, {{item = "conveyor_belt", baseCount = 1}}, 1, 1, "", {}, {}, building.f.conveyorBeltState, nil --[[functoion to make it work, there's none rn]], nil, nil, nil, {items = {}, shadows = false, shadowIndexSprite = "circle"})
