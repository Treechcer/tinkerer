...
function spw.init()
    spw.generateNewSprite("cursor", {love.graphics.newImage("assets/sprites/cursor1.png"), love.graphics.newImage("assets/sprites/cursor2.png"), love.graphics.newImage("assets/sprites/cursor3.png"), love.graphics.newImage("assets/sprites/cursor4.png")}, 0.25)
    ...
    spw.generateNewSprite("cursorBuy",{ love.graphics.newImage("assets/sprites/cursor1.png"), love.graphics.newImage("assets/sprites/cursor2.png"), love.graphics.newImage("assets/sprites/cursor3.png"), love.graphics.newImage("assets/sprites/cursor4.png") }, 0.25)
    ...
    spw.generateNewSprite("conveyor_belt", { love.graphics.newImage("assets/sprites/conveyor_belt1.png"), love.graphics.newImage("assets/sprites/conveyor_belt2.png")}, 0.15, function () return true end)
    spw.generateNewSprite("conveyor_turn", { love.graphics.newImage("assets/sprites/conveyor_turn1.png"), love.graphics.newImage("assets/sprites/conveyor_turn2.png")}, 0.15, function () return true end)
    spw.generateNewSprite("conveyor_merge3", { love.graphics.newImage("assets/sprites/conveyor_merge3_1.png"), love.graphics.newImage("assets/sprites/conveyor_merge3_2.png")}, 0.15, function () return true end)
