...
function spw.init()
    ...
    spw.generateNewSprite("conveyor_belt", { love.graphics.newImage("assets/sprites/conveyor_belt01.png"), love.graphics.newImage("assets/sprites/conveyor_belt02.png")}, 0.15, function () return true end)
    spw.generateNewSprite("conveyor_turn", { love.graphics.newImage("assets/sprites/conveyor_turn01.png"), love.graphics.newImage("assets/sprites/conveyor_turn02.png")}, 0.15, function () return true end)
    spw.generateNewSprite("conveyor_merge3", { love.graphics.newImage("assets/sprites/conveyor_merge3_01.png"), love.graphics.newImage("assets/sprites/conveyor_merge3_02.png")}, 0.15, function () return true end)
